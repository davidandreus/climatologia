...
Gem::Specification.new do |spec|
  spec.name          = "climatology"
  spec.version       = Climatology::VERSION
  spec.authors       = ["davidsanhuezaandreus"]
  spec.email         = ["david.sanhueza.andreus@gmail.com"]

  spec.summary       = %q{Write a short summary, because RubyGems requires one.}
  spec.description   = %q{Write a longer description or delete this line.}
  spec.homepage      = "http://cloty.app/"
  spec.license       = "MIT"
